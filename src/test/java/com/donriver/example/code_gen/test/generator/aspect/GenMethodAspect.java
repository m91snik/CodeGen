package com.donriver.example.code_gen.test.generator.aspect;
...
public class GenMethodAspect {
    ...
    @Pointcut(
            "execution(@com.donriver.example.code_gen.test.generator.annotation.GenMethodAnnotation public com.donriver.example.code_gen.test.generator.protocol.TestResponse *(..))")
